...
${tw`bg-gray-400 text-black px-3 py-1 text-lg rounded-lg flex items-center text-center border border-transparent`}
...
${props => (props.danger ? tw`bg-red-500 text-white` : null)}
  ...
  ${props => (props.link ? tw`bg-transparent text-teal-500` : null)}
