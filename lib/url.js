var URL = (function() {
  ...
  URL.prototype = {
    ...
    set filename(value) {
      ...
      else this.pathname = value;
    },

    get parameterNames() {
      var seen = Object.create(null);
      return parseSearch(this.search)
        .map(function(pair) {
          return pair[0];
        })
        .filter(function(key) {
  ...
  Object.defineProperty(URL.prototype, "getParameterAll", {
    enumerable: false
  });
  Object.defineProperty(URL.prototype, "appendParameter", {
    enumerable: false
  });
